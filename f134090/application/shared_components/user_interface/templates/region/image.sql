...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4954335418102824384)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954335791640824384)
,p_plug_template_id=>wwv_flow_imp.id(4954335418102824384)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954336050997824384)
,p_plug_template_id=>wwv_flow_imp.id(4954335418102824384)
,p_name=>'Sub Regions'
