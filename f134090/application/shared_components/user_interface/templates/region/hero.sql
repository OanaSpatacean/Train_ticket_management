...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4954331976668824383)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954332263805824383)
,p_plug_template_id=>wwv_flow_imp.id(4954331976668824383)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954332542506824383)
,p_plug_template_id=>wwv_flow_imp.id(4954331976668824383)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954332898349824383)
,p_plug_template_id=>wwv_flow_imp.id(4954331976668824383)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954333107537824383)
,p_plug_template_id=>wwv_flow_imp.id(4954331976668824383)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954333418994824383)
,p_plug_template_id=>wwv_flow_imp.id(4954331976668824383)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
