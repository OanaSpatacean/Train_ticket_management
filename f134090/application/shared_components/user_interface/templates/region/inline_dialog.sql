...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4954340880835824387)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954341156599824387)
,p_plug_template_id=>wwv_flow_imp.id(4954340880835824387)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954341454698824387)
,p_plug_template_id=>wwv_flow_imp.id(4954340880835824387)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954341786323824387)
,p_plug_template_id=>wwv_flow_imp.id(4954340880835824387)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954342041921824387)
,p_plug_template_id=>wwv_flow_imp.id(4954340880835824387)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954342332246824388)
,p_plug_template_id=>wwv_flow_imp.id(4954340880835824387)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954342684756824388)
,p_plug_template_id=>wwv_flow_imp.id(4954340880835824387)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954342941715824388)
,p_plug_template_id=>wwv_flow_imp.id(4954340880835824387)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954343287331824388)
,p_plug_template_id=>wwv_flow_imp.id(4954340880835824387)
,p_name=>'Sub Regions'
