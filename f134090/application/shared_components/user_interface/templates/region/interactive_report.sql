...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4954355472355824393)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954355725041824393)
,p_plug_template_id=>wwv_flow_imp.id(4954355472355824393)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954356087294824393)
,p_plug_template_id=>wwv_flow_imp.id(4954355472355824393)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954356388358824393)
,p_plug_template_id=>wwv_flow_imp.id(4954355472355824393)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954356610717824393)
,p_plug_template_id=>wwv_flow_imp.id(4954355472355824393)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954356940691824394)
,p_plug_template_id=>wwv_flow_imp.id(4954355472355824393)
,p_name=>'Sub Regions'
