...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4954317553486824376)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954317821798824376)
,p_plug_template_id=>wwv_flow_imp.id(4954317553486824376)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954318126845824376)
,p_plug_template_id=>wwv_flow_imp.id(4954317553486824376)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954318495419824376)
,p_plug_template_id=>wwv_flow_imp.id(4954317553486824376)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954318768282824376)
,p_plug_template_id=>wwv_flow_imp.id(4954317553486824376)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954319089953824377)
,p_plug_template_id=>wwv_flow_imp.id(4954317553486824376)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954319305016824377)
,p_plug_template_id=>wwv_flow_imp.id(4954317553486824376)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954319685272824377)
,p_plug_template_id=>wwv_flow_imp.id(4954317553486824376)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954319964533824377)
,p_plug_template_id=>wwv_flow_imp.id(4954317553486824376)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954320218614824377)
,p_plug_template_id=>wwv_flow_imp.id(4954317553486824376)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954320552215824377)
,p_plug_template_id=>wwv_flow_imp.id(4954317553486824376)
,p_name=>'Sub Regions'
