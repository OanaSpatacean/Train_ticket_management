...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4954350093790824391)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954350370827824391)
,p_plug_template_id=>wwv_flow_imp.id(4954350093790824391)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954350667763824391)
,p_plug_template_id=>wwv_flow_imp.id(4954350093790824391)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954350997417824391)
,p_plug_template_id=>wwv_flow_imp.id(4954350093790824391)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954351211068824391)
,p_plug_template_id=>wwv_flow_imp.id(4954350093790824391)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954351573843824391)
,p_plug_template_id=>wwv_flow_imp.id(4954350093790824391)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954351873482824391)
,p_plug_template_id=>wwv_flow_imp.id(4954350093790824391)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954352112000824392)
,p_plug_template_id=>wwv_flow_imp.id(4954350093790824391)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954352437760824392)
,p_plug_template_id=>wwv_flow_imp.id(4954350093790824391)
,p_name=>'Sub Regions'
