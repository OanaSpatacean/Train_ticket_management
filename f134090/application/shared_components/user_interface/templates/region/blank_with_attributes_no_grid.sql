...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4954300064489824368)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954300386286824368)
,p_plug_template_id=>wwv_flow_imp.id(4954300064489824368)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954300603549824368)
,p_plug_template_id=>wwv_flow_imp.id(4954300064489824368)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954300975271824368)
,p_plug_template_id=>wwv_flow_imp.id(4954300064489824368)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954301272420824368)
,p_plug_template_id=>wwv_flow_imp.id(4954300064489824368)
,p_name=>'Sub Regions'
