...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4954298687410824367)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954298944054824367)
,p_plug_template_id=>wwv_flow_imp.id(4954298687410824367)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954299200330824368)
,p_plug_template_id=>wwv_flow_imp.id(4954298687410824367)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954299548613824368)
,p_plug_template_id=>wwv_flow_imp.id(4954298687410824367)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954299891695824368)
,p_plug_template_id=>wwv_flow_imp.id(4954298687410824367)
,p_name=>'Sub Regions'
