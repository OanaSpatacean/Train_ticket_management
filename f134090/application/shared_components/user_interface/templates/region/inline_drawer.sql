...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4954345439910824389)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954345769923824389)
,p_plug_template_id=>wwv_flow_imp.id(4954345439910824389)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954346071100824389)
,p_plug_template_id=>wwv_flow_imp.id(4954345439910824389)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954346382956824389)
,p_plug_template_id=>wwv_flow_imp.id(4954345439910824389)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954346621924824389)
,p_plug_template_id=>wwv_flow_imp.id(4954345439910824389)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954346975027824390)
,p_plug_template_id=>wwv_flow_imp.id(4954345439910824389)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954347259515824390)
,p_plug_template_id=>wwv_flow_imp.id(4954345439910824389)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954347578093824390)
,p_plug_template_id=>wwv_flow_imp.id(4954345439910824389)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954347808607824390)
,p_plug_template_id=>wwv_flow_imp.id(4954345439910824389)
,p_name=>'Sub Regions'
