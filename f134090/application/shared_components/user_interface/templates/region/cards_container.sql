...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4954305759381824370)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954306003832824371)
,p_plug_template_id=>wwv_flow_imp.id(4954305759381824370)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954306308248824371)
,p_plug_template_id=>wwv_flow_imp.id(4954305759381824370)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954306670343824371)
,p_plug_template_id=>wwv_flow_imp.id(4954305759381824370)
,p_name=>'Sub Regions'
