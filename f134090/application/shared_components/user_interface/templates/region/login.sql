...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4954360016079824395)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954360388692824395)
,p_plug_template_id=>wwv_flow_imp.id(4954360016079824395)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954360672711824395)
,p_plug_template_id=>wwv_flow_imp.id(4954360016079824395)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954360933908824395)
,p_plug_template_id=>wwv_flow_imp.id(4954360016079824395)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954361280443824395)
,p_plug_template_id=>wwv_flow_imp.id(4954360016079824395)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954361578820824395)
,p_plug_template_id=>wwv_flow_imp.id(4954360016079824395)
,p_name=>'Sub Regions'
