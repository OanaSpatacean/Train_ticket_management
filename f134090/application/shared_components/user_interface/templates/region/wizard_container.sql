...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4954382746873824405)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954383007897824405)
,p_plug_template_id=>wwv_flow_imp.id(4954382746873824405)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954383311042824405)
,p_plug_template_id=>wwv_flow_imp.id(4954382746873824405)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954383661494824405)
,p_plug_template_id=>wwv_flow_imp.id(4954382746873824405)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954383947982824405)
,p_plug_template_id=>wwv_flow_imp.id(4954382746873824405)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954384231153824406)
,p_plug_template_id=>wwv_flow_imp.id(4954382746873824405)
