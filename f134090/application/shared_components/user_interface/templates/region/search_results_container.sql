...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4954362550835824396)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954362842125824396)
,p_plug_template_id=>wwv_flow_imp.id(4954362550835824396)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954363117940824396)
,p_plug_template_id=>wwv_flow_imp.id(4954362550835824396)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954363468466824396)
,p_plug_template_id=>wwv_flow_imp.id(4954362550835824396)
,p_name=>'Sub Regions'
