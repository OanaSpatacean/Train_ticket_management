...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4954327398333824380)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954327676605824380)
,p_plug_template_id=>wwv_flow_imp.id(4954327398333824380)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954327939483824381)
,p_plug_template_id=>wwv_flow_imp.id(4954327398333824380)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954328232643824381)
,p_plug_template_id=>wwv_flow_imp.id(4954327398333824380)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954328562643824381)
,p_plug_template_id=>wwv_flow_imp.id(4954327398333824380)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954328809735824381)
,p_plug_template_id=>wwv_flow_imp.id(4954327398333824380)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954329181005824381)
,p_plug_template_id=>wwv_flow_imp.id(4954327398333824380)
,p_name=>'Sub Regions'
