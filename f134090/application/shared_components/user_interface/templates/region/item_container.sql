...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4954357586175824394)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954357828756824394)
,p_plug_template_id=>wwv_flow_imp.id(4954357586175824394)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954358174171824394)
,p_plug_template_id=>wwv_flow_imp.id(4954357586175824394)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954358494244824394)
,p_plug_template_id=>wwv_flow_imp.id(4954357586175824394)
,p_name=>'Button Start'
