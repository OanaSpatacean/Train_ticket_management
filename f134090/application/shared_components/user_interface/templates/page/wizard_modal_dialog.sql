...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(4954291924882824363)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954292240690824364)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954292505497824364)
,p_page_template_id=>wwv_flow_imp.id(4954291924882824363)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954292857883824364)
,p_page_template_id=>wwv_flow_imp.id(4954291924882824363)
