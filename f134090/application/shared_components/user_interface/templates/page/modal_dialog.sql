...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(4954283347227824360)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954283658371824360)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954283949144824360)
,p_page_template_id=>wwv_flow_imp.id(4954283347227824360)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954284297278824360)
,p_page_template_id=>wwv_flow_imp.id(4954283347227824360)
