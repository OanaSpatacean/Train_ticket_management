...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(4954273387129824355)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954273674443824355)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954273965268824355)
,p_page_template_id=>wwv_flow_imp.id(4954273387129824355)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954274286967824355)
,p_page_template_id=>wwv_flow_imp.id(4954273387129824355)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4954274542467824356)
,p_page_template_id=>wwv_flow_imp.id(4954273387129824355)
,p_name=>'Body Footer'
