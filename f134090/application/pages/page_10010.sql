...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4954776381230824553)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4954776413668824553)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(4954778862071824556)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(4954776381230824553)
,p_button_name=>'SAVE'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(4954777482764824554)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(4954779249734824556)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4954779569765824556)
,p_name=>'P10010_DESKTOP_THEME_STYLE_ID'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(4954776413668824553)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4954780298913824558)
...
,p_lov=>'.'||wwv_flow_imp.id(4954780364818824558)||'.'
,p_grid_label_column_span=>0
,p_field_template=>wwv_flow_imp.id(4954635784185824431)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(4954777532683824555)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(4954777482764824554)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(4954778212698824555)
,p_event_id=>wwv_flow_imp.id(4954777532683824555)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(4954781426207824559)
...
,p_internal_uid=>4954781426207824559
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(4954781812994824559)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_success_message=>'Application Appearance Settings Saved.'
,p_internal_uid=>4954781812994824559
);
